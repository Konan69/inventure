...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_hsl(30_10%_8%_/_0.15)_inset]",
      className
    )}
    {...props}
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        ...
        <h3 className="text-xl font-semibold text-neutral-700 dark:text-foreground">
          {name}
        </h3>
        <p className="max-w-lg text-neutral-400 dark:text-muted-foreground">
          {description}
        </p>
      </div>
